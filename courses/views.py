...
#FOr the next two classes ,,this is a class based generic view wherre
#In this case, the inferred template will be "courses/course_list.html" – the “courses”
#part comes from the name of the app that defines the model, while the “course_list/detail_list”
